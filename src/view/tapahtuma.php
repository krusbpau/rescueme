...
<div>Osoite: <?=$tapahtuma['paikka']?></div>
<div>Ilmoittautuneita: <?=$ilmoittautuneita?></div>
<div>Paikkoja: <?=$tapahtuma['osallistujia']?></div>
<div></div>
</div>
</div>
...
<?php
  ...
  echo "</div>";
   ...
   echo "<div class='info'>Tapahtuma täynnä!</div>";
   }
 }
}
?>
